...
public class MethodExampleView {
	...
	// (캡슐화 원칙에 따라서 private)
	private Scanner sc = new Scanner(System.in); // 지역변수 -> 멤버 변수 (대신 private써야함)
...
//		Scanner sc = new Scanner(System.in); // displayMenu에서만 쓸 수 있는 [지역변수]
		...
		do {
			...
			//
			case 2: //service.method2(80,50,72);
//				this.menu2(); //또는
