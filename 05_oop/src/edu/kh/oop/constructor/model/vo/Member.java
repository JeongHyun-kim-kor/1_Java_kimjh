...
public class Member { 
	...
	// 캡슐화 -> 추상화 결과를 묶고, 데이터 직접 접근을 제한한다.
	...
	// == 동일한 메서드(또는 생성자)명으로 여러 메소드를 작성하는 것
...
//	     ex) int char > char , int
	...
	public Member(String memberId, String memberPw) {
		// 매개변수 개스가 달라서 오버로딩 성립 (4개 > 2개)
		// 순서가 달라서 ( int age가 첫번째)
		// 데이터 타입이 달라서 다 가능 (int age 대신 double age)
	}
	
	// ** 오버로딩 주의 사항 **
	// 매개변수의 자료형의 타입, 개수 순서 중 하나라도 달ㄹ라야 한다!
	//public Member(String memberPw, String memberId)	{  // 불가함 String String / String String
...
//	}
	...
	public Member(String memberID, int memberAge, String memberPhone) {
		...
		this(memberAge, memberPhone); // this() 생성자 호출 > 바로 위 생성자로 이동
